...
function createEntity(entityName) {
  return {
    ...
    async batchUpdate(updates) {
      const res = await fetch(`${API_BASE}/${entityName}/batch`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
...
export const base44 = {
  entities: {
    ...
    DemoOrder: createEntity('DemoOrder'),
    DemoNext10DaysRecord: createEntity('DemoNext10DaysRecord'),
    DemoNext10DaysUpload: createEntity('DemoNext10DaysUpload'),
  },
  auth: {
    async me() {
