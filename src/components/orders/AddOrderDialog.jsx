...
function ConfirmOrderDialog({ orderData, onConfirm, onCancel }) {
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 10, marginTop: 20 }}>
          <button
            onClick={onCancel}
            style={{ height: 40, padding: '0 20px', fontSize: 14, fontWeight: 600, background: 'white', border: '1px solid #d1d5db', borderRadius: 6, color: '#374151', cursor: 'pointer' }}
          ...
          <button
            onClick={onConfirm}
            style={{ height: 40, padding: '0 20px', fontSize: 14, fontWeight: 600, background: '#fd5108', border: 'none', borderRadius: 6, color: 'white', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6 }}
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '20px 28px', display: 'flex', flexDirection: 'column', gap: 16 }}>
                          ...
                          {dropdownProducts.greyed.length > 0 && (
                            <>
                              ...
                              {dropdownProducts.greyed.map(p => (
                                <div
                                  key={p.fg_material_code}
                                  title="No production history on any line. Update Knowledge Base to enable this product."
            ...
            <Section title="Scheduling">
              ...
              <Field label="Availability" required>
                ...
                {availType === 'date' && (
                  <input type="date" style={{ ...INPUT_STYLE, marginTop: 8 }} value={availDate} onChange={e => setAvailDate(e.target.value)} data-testid="input-avail-date" />
                )}
                {availType === 'custom' && (
