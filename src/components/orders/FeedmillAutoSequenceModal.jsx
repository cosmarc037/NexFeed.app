...
function FMAfterRow({ order, prio, provided, snapshot, destinationLine }) {
...
/* ── Main modal ── */
export default function FeedmillAutoSequenceModal({ data, isLoading = false, changeoverRules, onApply, onCancel }) {
