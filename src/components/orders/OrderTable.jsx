...
import { generateProductAIInsights } from "@/services/azureAI";
...
export default function OrderTable({
  ...
  const COL_META = {
    ...
    completion_date: { label: "Completion Date", width: 160 },
  ...
  const GROUP_COLS = {
    ...
    scheduling: ["start_date", "start_time", "avail_date", "completion_date"],
    ai: ["smart_insight"],
    notes: ["fpr_notes", "special_remarks"],
    bagger_details: ["threads", "sacks", "markings", "tags"],
    completion_tracking: ["end_date", "history"],
  };
  ...
  const shouldCancelDrag = (e) => {
    const target = e.target;
    if (target.nodeType === Node.TEXT_NODE) return true;
    let el = target;
    while (el && el !== e.currentTarget) {
      if (el.classList?.contains("drag-handle-cell")) return false;
      ...
      if (
        ...
        return true;
      if (tag === "p" || tag === "span" || tag === "label") return true;
      if (
      ...
      if (
        el.classList?.contains("select-trigger") ||
  ...
  // Build visible orders: hide children whose parent lead is collapsed
  ...
  return (
    <TooltipProvider delayDuration={200}>
      ...
      tr[data-rfd-draggable-id] td label,
      tr[data-rfd-draggable-id] td a { cursor: text; user-select: text; }
      tr[data-rfd-draggable-id] input,
      tr[data-rfd-draggable-id] select,
      tr[data-rfd-draggable-id] textarea { cursor: text; }
      tr[data-rfd-draggable-id] button,
      tr[data-rfd-draggable-id] [role="combobox"],
      tr[data-rfd-draggable-id] [data-no-drag="true"] { cursor: pointer; }
      tr[data-rfd-draggable-id] td.drag-handle-cell,
      tr[data-rfd-draggable-id] td.drag-handle-cell div,
      tr[data-rfd-draggable-id] td.drag-handle-cell svg { cursor: grab; }
      ...
      .hideable-col-header { position: relative; }
      .hideable-col-header .col-hide-btn { display: none; position: absolute; top: 2px; right: 2px; background: rgba(255,255,255,0.95); color: #9ca3af; font-size: 10px; padding: 1px 4px; border-radius: 3px; cursor: pointer; line-height: 1.4; border: 1px solid #d1d5db; transition: background 0.15s, color 0.15s, border-color 0.15s; }
      .hideable-col-header:hover .col-hide-btn { display: block; }
      .col-hide-btn:hover { color: #e53935 !important; background: #fef2f2 !important; border-color: #fecaca !important; }
      .hideable-col-header .col-hide-btn { z-index: 2; }
    ...
    `}</style>
              ...
              <thead style={{ position: "sticky", top: 0, zIndex: 20 }}>
                <tr>
                  ...
                  {isGroupHidden("completion_tracking") ? (
                    <th
                      ...
                      title={`Double-click to show Completion & Tracking (${GROUP_COLS.completion_tracking.length} columns)`}
                    />
                  ) : (
                    <th
                ...
                <tr style={{ background: "#f9fafb" }}>
                  ...
                  {isHidden("readiness") ? (
                    ...
                    <th style={{ background: "#f5f7f8" }} className={CH}>
                      <div className="hideable-col-header">
                        <span
                  ...
                  {isGroupHidden("mixer_details") ? (
                    ...
                    <>
                      {isHidden("ha_info") ? (
                        ...
                        <th style={{ background: "#f8f0fb" }} className={CH}>
                          <div className="hideable-col-header">
                            HA Info
                            <span
                              className="col-hide-btn"
                  ...
                  {isHidden("status") ? (
                    ...
                    <th style={{ background: "#ffe8d4" }} className={CH}>
                      <div className="hideable-col-header">
                        Status
                        <span
                          className="col-hide-btn"
                  ...
                  {isGroupHidden("notes") ? (
                    ...
                    <>
                      {isHidden("fpr_notes") ? (
                        ...
                        <th style={{ background: "#fff" }} className={CH}>
                          <div className="hideable-col-header">
                            FPR Notes
                            <span
                              className="col-hide-btn"
                  ...
                  {isGroupHidden("bagger_details") ? (
                    ...
                    <>
                      {isHidden("threads") ? (
                        ...
                        <th style={{ background: "#f1f9f2" }} className={CH}>
                          <div className="hideable-col-header">
                            Threads
                            <span
                              className="col-hide-btn"
                          ...
                          >
                            {(draggableProvided, snapshot) => (
                              <tr
                                ...
                                onMouseDown={(e) => {
                                  ...
                                  if (
                                    ...
                                    draggableProvided.dragHandleProps.onMouseDown(
                                      e,
                                    );
                                  }
                                }}
                                onTouchStart={(e) => {
                                  ...
                                  if (
                                    ...
                                    draggableProvided.dragHandleProps.onTouchStart(
                                      e,
                                    );
                                  }
                                }}
                              ...
                              >
                                {isDraggable && (
                                  <td
                                    className={`${cellBase} text-gray-300 hover:text-gray-500 px-1 drag-handle-cell`}
                                  >
                                    {!isCompleted &&
                                      !isCancelled &&
                                      !isChild && (
                                  ...
                                  <>
                                    ...
                                    {isHidden("completion_date") ? (
                                      ...
                                      <td
                                        ...
                                        data-col-label="Completion Date"
                                        style={{
                                          position: "relative",
                                          overflow: "visible",
                                        }}
                                ...
                                {isGroupHidden("completion_tracking") ? (
                                  <td
                                    ...
                                    title="Double-click to show Completion & Tracking"
                                  />
                                ) : (
                                  <>
                                    {/* End Date — hideable */}
      ...
      {dateViolationToast && (
        <div
          onMouseEnter={() => clearTimeout(violationTimerRef.current)}
          onMouseLeave={() => {
            violationTimerRef.current = setTimeout(
              () => setDateViolationToast(null),
              60000,
...
function VolumeCell({
  ...
  const handleProceed = () => {
    ...
    setEditValue(String(fmtVolume(effVol)));
  };
        ...
        {canEdit && (
          <div className="absolute top-0 right-0 mt-0.5 mr-0.5">
            <button
              ...
              title="Volume overridden"
              data-testid={`button-volume-unlock-${order.id}`}
              data-no-drag="true"
            >
            ...
            >
              ...
              <div className="flex gap-2 justify-end">
                ...
                <Button
                  ...
                  onClick={() => {
                    onUpdate(order.id, { volume_override: null });
                    setOverrideOpen(false);
                  }}
                >
                  Revert
    ...
    <div className="relative">
      {!unlocked && canEdit && (
        <div className="absolute top-0 right-0 mt-0.5 mr-0.5">
          <button
            ...
            data-testid={`button-volume-lock-${order.id}`}
            data-no-drag="true"
          >
        ...
        {unlocked ? (
          <div className="group">
            <Input
              ...
              autoFocus
              className={cn(
                "border-0 border-b border-[#fd5108] bg-transparent shadow-none rounded-none px-0 h-7 text-[13px] md:text-[13px] font-bold focus-visible:ring-0 w-20",
              )}
              data-testid={`input-volume-override-${order.id}`}
            />
          </div>
        ) : (
          <p className="text-[13px] font-bold text-gray-900">
      ...
      {overrideOpen && (
        ...
        >
          ...
          >
            <p className="text-[18px] font-bold text-gray-900 mb-2">
              Override Suggested Volume
            </p>
            <p className="text-[14px] leading-relaxed text-gray-500 mb-4">
              You are about to override the Suggested Volume. This will affect
              Number of Batches, Number of Bags, Production Hours, and
              Completion Date.
            </p>
            <div className="flex gap-2 justify-end">
              <Button
...
function AvailDateCell({ order, canEdit, onUpdate, inferredInfo = null }) {
  ...
  const originalLine =
    isAutoSequenced && origVal && origVal !== val
      ? (
          <p className="text-[12px] text-[#6b7280] mt-0.5">
            {origIsDate ? origDisplay : origVal}
          </p>
        )
      : null;

  // Small icon to the right of the avail date text based on N10D data
  const inferredIcon = (() => {
    // For auto-sequenced orders with a valid date, check if N10D target date has changed
    if (isAutoSequenced && inferredInfo && (valIsDate || isStockSufficient)) {
      // Sufficient orders: compare against actual N10D window-end date (not sentinel)
      const newTarget =
      ...
      // Backward compat: old 'stock_sufficient' sentinel counts as unchanged for Sufficient
      ...
      if (targetChanged) {
        ...
        return (
          <span
            title={`Target date changed: ${fmtShort(lastTarget)} → ${fmtShort(newTarget)}. Run Auto-Sequence to update.`}
    ...
    // Use the pre-computed status from inferredTargetMap — do NOT recalculate
    ...
    const completionFull = inferredInfo.targetDate
      ...
      : "—";
    const iconStyle = {
      cursor: "pointer", padding: 4, margin: -4, borderRadius: 4,
    ...
    if (status === "Sufficient") {
      return (
        <span title={tipText} style={iconStyle}>
...
function CompletionDateCell({ order, canEdit, onUpdate }) {
  ...
  const handleProceed = () => {
    ...
    if (m) {
      ...
      const h24 =
        m[6].toUpperCase() === "PM" && parseInt(m[4]) < 12
          ? parseInt(m[4]) + 12
          : m[6].toUpperCase() === "AM" && parseInt(m[4]) === 12
            ? 0
            : parseInt(m[4]);
      setEditTime(`${String(h24).padStart(2, "0")}:${m[5]}`);
    }
  };
    ...
    if (editDate) {
      ...
      if (!isNaN(d.getTime())) {
        ...
        if (editTime) {
          ...
          h = h % 12 || 12;
          timeStr = `${String(h).padStart(2, "0")}:${mm} ${ampm}`;
        }
      ...
      <div className="space-y-1">
        ...
        <div className="group">
          <Input
            ...
            className={cn(line2InputClass, "w-24")}
            data-testid={`input-completion-time-${order.id}`}
          />
        </div>
        <div className="flex gap-1 mt-1">
          <Button
          ...
          >
            ...
            <ul className="text-[13px] text-gray-500 mb-4 space-y-1.5 list-disc pl-4">
              ...
              <li>
                ...
                Start Date/Time and Completion Date recalculated based on your
                new date.
              </li>
              <li>
...
function EndDateCell({ order, canEditDirect, onUpdate }) {
  ...
  const handleOk = () => {
    if (editDate)
      onUpdate(order.id, { end_date: editDate, end_time: editTime || null });
    setUnlocked(false);
    setEditDate("");
    setEditTime("");
  };
          ...
          {unlocked ? (
            <div className="space-y-1">
              ...
              <Input
                ...
                value={editTime}
                onChange={(e) => setEditTime(e.target.value)}
                className={cn(line2InputClass, "w-20")}
            ...
            <div>
              ...
              {order.end_time && (
                <p className="text-[13px] text-[#6b7280]">
                  End: {formatTime12(order.end_time)}
                </p>
              )}
            </div>
          )}
