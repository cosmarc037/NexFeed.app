  ...
  Object.values(matchGroups).forEach((orders) => {
    ...
    while (remaining.length > 0) {
      ...
      for (let i = remaining.length - 1; i >= 0; i--) {
        ...
        const candidateCombinedVolumeMT = vol + cv;
        const combinationAllowed = candidateCombinedVolumeMT <= MAX_COMBINE_MT;
        console.debug('[Order Combine Cap Check]', { combineCapMT: MAX_COMBINE_MT, candidateCombinedVolumeMT, withinCap: combinationAllowed });
...
export default function UploadAutoSequencePreview({
  ...
  return (
    <div className="plant-modal-overlay nexfeed-force-light" style={{ zIndex: 10000 }}>
        ...
        {!isProcessing && sequencedResults && summaryStats && (
          <>
            ...
            <div className="plant-tab-bar">
              ...
              >
                <span style={{ filter: 'grayscale(1)', opacity: 0.7 }}>📊</span> All Lines Summary
              </button>
