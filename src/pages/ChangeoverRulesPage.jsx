...
export default function ChangeoverRulesPage({ onSave }) {
  ...
  return (
    <div className="changeover-rules-page" data-tour="changeover-rules-page">
      <div className="changeover-rules-header" data-tour="changeover-rules-header">
        <div>
      ...
      <div className="changeover-rules-description" data-tour="changeover-rules-description">
        <p>
      ...
      <div className="changeover-rules-cards" data-tour="changeover-rules-cards">
        {rules.map((rule) => (
          <ChangeoverRuleCard
            key={rule.id}
            rule={rule}
