          ...
          >
            ...
            {data.adjustedInventory && (
              <>
                ...
                />
                <span style={lbl}>Adj. Inventory:</span>
                <span
                  style={{
                    ...val,
                    color:
                      data.adjustedInventory.value < data.adjustedInventory.inventory
                        ? "#fca5a5"
                        : "#86efac",
                  }}
                >
                  {Number(data.adjustedInventory.value).toFixed(1)} MT
                </span>
                <span
                  style={{
                    ...lbl,
                ...
                >
                  = {Number(data.adjustedInventory.inventory).toFixed(1)} (Inventory) −{" "}
                  {Number(data.adjustedInventory.satisfied).toFixed(1)} (satisfied order
                  vol) + {Number(data.adjustedInventory.avgDaily).toFixed(1)} (avg daily,
                  mean of day 1–10)
                </span>
              </>
            )}
